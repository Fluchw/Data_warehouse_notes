...
![image](数仓2数据装载脚本/dwd_to_dws_1d_init.sh]]
![image](数仓2数据装载脚本/dwd_to_dws_1d.sh]]

```shell
chmod +x dwd_to_dws_1d_init.sh
...
![image](数仓2数据装载脚本/dws_1d_to_dws_nd.sh]]

```shell
chmod +x dws_1d_to_dws_nd.sh
...
![image](数仓2数据装载脚本/dws_1d_to_dws_td_init.sh]]
![image](数仓2数据装载脚本/dws_1d_to_dws_td.sh]]

```shell
chmod +x dws_1d_to_dws_td_init.sh
dws_1d_to_dws_td_init.sh all 2020-06-14

chmod +x dws_1d_to_dws_td.sh
